...
namespace Kitpymes.Core.Security
{
    ...
    */
    ...
    public static class PasswordServiceCollectionExtensions
    {
        ...
        /// <param name="enabled">Si se habilita el del servicio de contraseñas.</param>
        /// <returns>IServiceCollection.</returns>
        public static IServiceCollection LoadPassword(
            this IServiceCollection services,
            Action<PasswordOptions>? options = null,
            bool enabled = true)
        {
            ...
            return services.LoadPassword(config.PasswordSettings);
        }
